    ...
    useEffect(() => {
        ...
        appointmentService.getAppointmentById(id).then((resp) => {
            setAppointment({
                ...
                hour: resp[0].hora,
                doctor: resp[0].nombrePaciente + ' ' + resp[0].apPaternoPaciente + ' ' + resp[0].apMaternoPaciente,
                patient: resp[0].nombreDoctor + ' ' + resp[0].apPaternoDoctor + ' ' + resp[0].apMaternoDoctor,
                cost: resp[0].costo,
